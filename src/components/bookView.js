...
class BookView extends React.Component {
    state = {
        bookDetails: [{ index: Math.random(), name: "", author: "", type: "", dateOfPublish: "", price: "" }]
    }
    handleChange = (e) => {
    ...
    addNewRow = (e) => {
        this.setState((prevState) => ({
            bookDetails: [...prevState.bookDetails, { index: Math.random(), name: "", author: "", type: "", dateOfPublish: "", price: "" }],
        }));
    }
                ...
                <form onSubmit={this.handleSubmit} onChange={this.handleChange}>
                    <div className="row" style={{ marginTop: 20 }}>
                        ...
                        <div className="col-sm-10">
                            <div className="card-header text-center"> Enter Book Details</div>
                            <div className="container">
                                <div className="row">
                                    <BookList add={this.addNewRow} delete={this.clickOnDelete.bind(this)} bookDetails={bookDetails} />
